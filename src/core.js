...
function remainingBakeTime(minutesBaked) {
  return bakingTime() - minutesBaked
}
...
function totalTimeSpent(layers, minutesBaked) {
  return calculatePreparationTime(layers) + minutesBaked
}
